...
saveRDS(mrna.count.matrix, file = here('extractedData', 'rnaSeqMatrixFormatted', 'counts.RNA-seq-matrix.min-count-filtered.rds'))
saveRDS(rpm.matrix, file = here('extractedData', 'rnaSeqMatrixFormatted', 'rpm.RNA-seq-matrix.min-count-filtered.rds'))
saveRDS(tpm.matrix, file = here('extractedData','rnaSeqMatrixFormatted',  'tpm.RNA-seq-matrix.min-count-filtered.rds'))